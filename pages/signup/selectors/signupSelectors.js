...
import { signupStaticSelectors } from "./signupStaticSelectors";

export function onboarding(page){

    const onboardingConnectGoogleAnalytics = page.getByRole('link', { name: signupStaticSelectors.dataSourceGoogleAnalytics});
    const onboardingConnectFacebook = customByText(page , signupStaticSelectors.ConnectMetaAds )
...
export function signupComplete(page){
